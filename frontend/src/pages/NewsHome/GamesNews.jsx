  ...
  return (
    <div className="m-5">
      ...
      <div className="border-2 border-gray-400 rounded-md p-3">
        {games?.slice(0, 2).map((post) => (
          <div
            key={post._id}
            className="flex flex-col md:flex-row gap-4 mb-4 p-4 border-2 rounded-md border-b border-gray-300"
          >
            <img
            ...
            <div className="flex flex-col">
              ...
              <Link to={`/games`} className="mt-2 text-blue-600 text-sm">
                ReadMore
              </Link>
            </div>
          </div>
